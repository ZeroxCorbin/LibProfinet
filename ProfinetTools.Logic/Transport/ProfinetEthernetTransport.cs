...
namespace ProfinetTools.Logic.Transport
{
	public class ProfinetEthernetTransport : IDisposable
	{
		...
		public static DCP.IpInfo GetPcapIp(SharpPcap.ILiveDevice pcapDevice)
		{
		...
		{
			if (e.GetPacket().LinkLayerType != PacketDotNet.LinkLayers.Ethernet) return;
			PacketDotNet.Utils.ByteArraySegment bas = new PacketDotNet.Utils.ByteArraySegment(e.Data.ToArray());
